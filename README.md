I am a Computer Science Master's student studying at King's College London.
...
- [A GIF decoder and encoder](https://github.com/shaksternano/gifcodec) written in Kotlin, that features lossless compression, parallel encoding, and an easy to use API.
